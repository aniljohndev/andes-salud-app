...
public class ItemPickerDialogFragment extends DialogFragment {
    public static final String LOGTAG = "DialogFragment";
//    DialogButtonListener dialogButtonListener;
    ...
    public static class Item {
        ...
        public Item(String title, String value, Bundle bundle) {
            this.title = title;
            this.stringValue= value;
            this.b = bundle;
        }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(listener!=null){
                            if (0 <= selectedIndex && selectedIndex < items.size()) {
                                Item item = items.get(selectedIndex);
                                listener.onItemSelected(ItemPickerDialogFragment.this, item, selectedIndex);
//                                EventBus.getDefault().post("ftstunos");
//                                try {
//                                    dialogButtonListener.setOkDialog("oklinst",null);
//                                } catch (Exception e) {
//                                    e.printStackTrace();
//                                }
...
//    public void setDialogListener(DialogButtonListener trigger) {
//        this.dialogButtonListener = trigger;
//    }
